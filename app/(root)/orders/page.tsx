    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
            <div className="bg-white p-4 sm:p-8 rounded-xl shadow-lg w-full max-w-4xl">
                ...
                {orders.length === 0 ? (
                    <p className="text-center text-gray-600">You have not places any orders yet</p>
                ) : (
                                ...
                                <div className="p-4 sm:p-6 border-b border-gray-200">
                                    ...
                                    <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
                                        <div className="flex items-center">
                                            ...
                                            <span
                                                className={`px-3 py-1 rounded-full text-sm capitalize ${order.status === "paid" ?
                                                ...
                                                <div className="flex items-center gap-3 sm:gap-4">
                                                    {product.product?.image && (
                                                        <div className="relative size-14 sm:size-16 flex-shrink-0 rounded-md overflow-hidden">
                                                            <Image
                                                                src={generateImageURL(product.product.image).url()}
                                                                alt={`${product.product?.name} image` || "Product image"}
                                                                fill
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-gray-600">
                                                            Quanitity: {product.quantity ?? "N/A"}
                                                        </p>
                                                    </div>
                                                </div>
