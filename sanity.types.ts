...
export type Order = {
  ...
  status?: "pending" | "shipped" | "delivered" | "paid" | "canceled";
  orderDate?: string;
};
...
// Source: ./sanity/lib/products/getProdductBySlug.ts
...
// Variable: SEARCHED_PRODUCTS_QUERY
// Query: *[            _type == "product"            && name match $searchParam            ] | order(name asc)
export type SEARCHED_PRODUCTS_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
